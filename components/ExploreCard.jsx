...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }) => (
  ...
  >
    ...
    {active !== id ? (
      ...
      <div className="absolute bottom-0 p-8 justify-start w-full flex-col bg-black-rgba rounded-b-[24px]">
        ...
        <h2 className="font-semibold text-white text-[24px] mt-[24px] sm:text-[32px]">{title}</h2>
      </div>
    )}
  </motion.div>
);
